    ...
    <View>
      {currentMenu === '전체' && (
        <ScrollView>
          ...
          >
            <Text style={{ marginRight: 5, color: 'gray', flex: 1 }}>상품 문의</Text>
            <Text numberOfLines={2} style={{ overflow: 'hidden', flex: 3 }}>
              구매했을 때보다 가격이 떨어졌어요 차액 환불이 되나요?
            </Text>
            <AntDesign name="down" size={24} color="black" style={{ flex: 0.5 }} />
          </View>
          <View
            style={{
              flexDirection: 'row',
          ...
          >
            <Text style={{ marginRight: 5, color: 'gray' }}>취소/반품(환불)</Text>
            <Text numberOfLines={2} style={{ overflow: 'hidden' }}>
